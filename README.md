...
| `vexos-desktop-nvidia-legacy580` | NVIDIA Maxwell/Pascal/Volta — required (580.x driver; 590+ dropped this hardware) |
...
| `vexos-stateless-nvidia-legacy580` | NVIDIA Maxwell/Pascal/Volta legacy, minimal stack |
...
| `vexos-server-nvidia-legacy580` | NVIDIA Maxwell/Pascal/Volta legacy |
...
| `vexos-headless-server-nvidia-legacy580` | NVIDIA Maxwell/Pascal/Volta legacy |
...
| `vexos-htpc-nvidia-legacy580` | NVIDIA Maxwell/Pascal/Volta legacy |

# home-server.nix
# Home Manager configuration for the primary user — GUI Server role.
    ...
    Service = {
      ...
      ExecStart       = toString (pkgs.writeShellScript "vexos-init-app-folders-server" ''
        ...
        $D write /org/gnome/desktop/app-folders/folders/Utilities/apps \
          "['com.mattjakeman.ExtensionManager.desktop', 'it.mijorus.gearlever.desktop', 'org.gnome.tweaks.desktop', 'io.github.flattool.Warehouse.desktop', 'io.missioncenter.MissionCenter.desktop', 'com.github.tchx84.Flatseal.desktop', 'org.gnome.World.PikaBackup.desktop', 'LocalSend.desktop', 'com.tmog.taskmanager.desktop']"

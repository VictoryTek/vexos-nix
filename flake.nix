{
  ...
  let
    ...
    # Modules shared across desktop/privacy configurations (includes home-manager + nix-gaming)
    commonModules = [
    ...
    # Modules for server/htpc roles — no home-manager, no gaming-specific tuning
    minimalModules = [
      /etc/nixos/hardware-configuration.nix
      unstableOverlayModule
    ];

...
if [ ! -f /etc/nixos/hardware-configuration.nix ]; then
  ...
  for TARGET in vexos-desktop-amd vexos-desktop-nvidia vexos-desktop-vm vexos-desktop-intel vexos-privacy-amd vexos-privacy-nvidia vexos-privacy-intel vexos-privacy-vm; do
  ...
  for TARGET in vexos-desktop-amd vexos-desktop-nvidia vexos-desktop-vm vexos-desktop-intel vexos-privacy-amd vexos-privacy-nvidia vexos-privacy-intel vexos-privacy-vm vexos-privacy-amd vexos-privacy-nvidia vexos-privacy-intel vexos-privacy-vm; do

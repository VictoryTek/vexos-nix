...

{
  ...
  # ---------- Assertions ----------
  # Fail the build if the primary user account is still locked (hashedPassword = "!").
  # An operator must run scripts/stateless-setup.sh (or write
  # /etc/nixos/stateless-user-override.nix manually) to set a real password
  # before the first nixos-rebuild on a stateless host.
  assertions = [
    {
